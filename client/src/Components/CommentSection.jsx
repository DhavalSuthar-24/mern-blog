        ...
        <div className="max-w-2xl  mx-auto w-full">{
            currentUser ? (
                <div className="flex  items-center gap-1 my-5 text-gray-600 text-sm">
                    <p>Signed in as:</p>
                    <img src={currentUser.profilepic} className="h-5 w-5 object-cover rounded-full" />
            ...
            currentUser && (
                <form className="border border-teal-500 rounded-md p-3 " onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between items-center  mt-5">
                        <p className="text-gray-500 text-xs"> {200 - comment.length} characters is remaining</p>
